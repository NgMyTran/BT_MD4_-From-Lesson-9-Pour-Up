...
@Configuration
@EnableTransactionManagement//chp phép quản lí giao diện thông qua anotation
public class HibernateConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/springmvc_orm_db?createDatabaseIfNotExist=true");
    ...
    public Properties additionalProperties() {
        ...
        properties.setProperty("hibernate.hbm2ddl.auto", "update"); //tự động thực hiện các câu lệnh Đl nếu cần thiết
    ...
    //3. Cấu hình Entity Manager Factory, nhaf masy quanr lys cacs tntity
    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("ra.model.entity");
    ...
    //chuaws cacs thao tac tuong tacs voiws bean thws 3 owr tren
    @Bean
